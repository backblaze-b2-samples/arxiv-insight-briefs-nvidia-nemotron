...
# `Settings()` instantiation never raises during test collection. We fail
...
app = FastAPI(
    title="arxiv-insight-briefs API",
    description=(
        "Problem-anchored arxiv research briefs, backed by Backblaze B2 "
        "for content-addressed PDF caching and durable brief archives."
    ),
    version="0.1.0",
    lifespan=lifespan,
)
